...
// ─── Geo-referencing ──────────────────────────────────────────
// GPS coordinates of the festival-map image edges (north = top).
// DEMO MODE: centred on Grafisch Lyceum Utrecht (Kon. Wilhelminalaan,
// 52.076853, 5.106178) so the GPS dot shows during the presentation.
// For the real event, swap these for the festival grounds' corners.
const MAP_BOUNDS = {
  north: 52.078653, // top edge    (y = 0)
  south: 52.075053, // bottom edge (y = MAP_H)
  west:  5.101143,  // left edge   (x = 0)
  east:  5.111213,  // right edge  (x = MAP_W)
};
